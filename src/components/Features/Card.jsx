...
const Card = ({title,des,icon}) => {
  return (
    ...
    <div className=' flex h-full flex-col gap-10 translate-y-16 group-hover:translate-y-0 transition-trasform  duration-500'>
    <div className=' w-10 h-8 flex flex-col justify-between'>
     ...
     <div className=' flex flex-col gap-6'>
          ...
          <p className='base font-semibold'>{des}</p>
